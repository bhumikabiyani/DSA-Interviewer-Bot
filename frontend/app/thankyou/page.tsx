      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400">Generating your evaluation...</p>
          </div>
        )}
        ...
        {/* No Session ID - Simple Thank You */}
        {!sessionId && !loading && (
          <div className="text-center py-8">
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              Great job working through the problems! Keep practicing to improve your skills.
            </p>
          </div>
        )}
